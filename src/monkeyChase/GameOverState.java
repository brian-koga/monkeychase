...
/**
 * This state is active when the Game is over. In this state a gameover menu is
 * displayed. Also a timer automatically transitions back to the StartUp State
 * if the user doesn't enter anything for a while.
 * 
